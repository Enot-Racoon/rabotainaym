...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_start" "enum_announcements_work_time_start";
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_end" "enum_announcements_work_time_end";
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_mon" boolean;
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_tue" boolean;
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_wed" boolean;
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_thu" boolean;
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_fri" boolean;
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_sat" boolean;
    ALTER TABLE "announcements"
      ADD COLUMN "work_time_days_sun" boolean;
    ALTER TABLE "announcements_rels"
      ADD CONSTRAINT "announcements_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."announcements" ("id") ON DELETE cascade ON UPDATE no action;
    ALTER TABLE "announcements_rels"
      ADD CONSTRAINT "announcements_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media" ("id") ON DELETE cascade ON UPDATE no action;
    ...
    ALTER TABLE "announcements"
      ADD CONSTRAINT "announcements_specialty_id_specialties_id_fk" FOREIGN KEY ("specialty_id") REFERENCES "public"."specialties" ("id") ON DELETE set null ON UPDATE no action;
    CREATE INDEX "announcements_specialty_idx" ON "announcements" USING btree ("specialty_id");
    ALTER TABLE "announcements"
      ADD COLUMN "author_id" integer;
    ALTER TABLE "announcements"
      ADD CONSTRAINT "announcements_author_id_users_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."users" ("id") ON DELETE set null ON UPDATE no action;
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
    ...
    DROP INDEX "announcements_author_idx";
    ...
    ALTER TABLE "announcements" DROP COLUMN "work_time_days_sun";
