...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "specialties_rels"
      ADD COLUMN "specialty_categories_id" integer;
    ...
    ALTER TABLE "specialties_rels"
      ADD CONSTRAINT "specialties_rels_specialty_categories_fk" FOREIGN KEY ("specialty_categories_id") REFERENCES "public"."specialty_categories" ("id") ON DELETE cascade ON UPDATE no action;
    ALTER TABLE "payload_locked_documents_rels"
      ADD CONSTRAINT "payload_locked_documents_rels_specialty_categories_fk" FOREIGN KEY ("specialty_categories_id") REFERENCES "public"."specialty_categories" ("id") ON DELETE cascade ON UPDATE no action;
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "specialties"
      ADD COLUMN "is_category" boolean;
    ALTER TABLE "specialties_rels"
