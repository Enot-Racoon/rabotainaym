const ru = {
  ...
  form: {
    labels: {
      ...
      specialty: 'Выберите Вашу специальность',
      skills: 'Опишите Ваши профессиональные навыки',
      'work-time': 'График работы',
    },
    placeholders: {
      email: {
      ...
      locality: 'Выберите Ваш населённый пункт',
      ...
      skills: 'Текст',
      'search-bar': 'Вид работы, услуга, профессия',
    },
    errors: {
      ...
      locality: 'Выберите населенный пункт',
      specialty: 'Выберите специальность',
      skills: 'Опишите профессиональные навыки',
      email: {
      ...
      startTime: 'Выберите начало рабочего времени',
      endTime: 'Выберите окончание рабочего времени',
    },
  },
  actions: {
    edit: 'Редактировать',
    ...
    'find-employee': 'Найти персонал',
  },
  mail: {
    otpEmailSubject: 'Вход на сайт Работа и найм',
    otpCode: 'Код для входа',
  },
} as const
